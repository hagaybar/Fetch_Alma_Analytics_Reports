...
You are free to use, modify, and distribute this software under the terms of the license. See the [LICENSE](https://mit-license.org/){:target="_blank"} for full details.
